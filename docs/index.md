...
The Littlest JupyterHub (TLJH) can run on any server that is running **Debian** version **11** or **12**, or **Ubuntu** version **22.04** or **24.04** on an amd64 or arm64 CPU architecture.
